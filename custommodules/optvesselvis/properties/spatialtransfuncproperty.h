...
#ifndef VRN_SPATIALTRANSFERFUNCPROPERTY_H
#define VRN_SPATIALTRANSFERFUNCPROPERTY_H
 ...
 */
class VRN_CORE_API SpatialTransFuncProperty : public TemplateProperty<TransFunc*>, public VolumeObserver {
public:
     ...
     */
    SpatialTransFuncProperty(const std::string& ident, const std::string& guiText,
    ...
    SpatialTransFuncProperty();
    virtual ~SpatialTransFuncProperty();

    virtual Property* create() const;

    virtual std::string getClassName() const       { return "SpatialTransFuncProperty"; }
    virtual std::string getTypeDescription() const { return "SpatialTransferFunction"; }
    virtual void reset();
     ...
     *
     * @note The SpatialTransFuncProperty takes ownership of the passed
    ...
    void setParamHandle(const VolumeBase* handle);
    ...
    const VolumeBase* getParamHandle() const;
    ...
    void setParamMagnitude(float paramMagnitude) { paramMagnitude_ = paramMagnitude; }

    float getParamMagnitude() { return paramMagnitude_; }

    void setWindowMode(int mode) { windowMode_ = mode; }

    int getWindowMode() { return windowMode_; }

    bool getKeysLocked() { return lockKeys_; }

    void setKeysLocked(bool locked) { lockKeys_ = locked; }
...
#endif // VRN_SPATIALTRANSFERFUNCPROPERTY_H
