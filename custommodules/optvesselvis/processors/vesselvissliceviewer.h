...
#ifndef VRN_VESSELVISSLICEVIEWER_H
#define VRN_VESSELVISSLICEVIEWER_H
 ...
 */
class VRN_CORE_API VesselVisSliceViewer : public SliceRendererBase {

public:
    VesselVisSliceViewer();
    virtual ~VesselVisSliceViewer();
    virtual Processor* create() const;

    virtual std::string getClassName() const    { return "VesselVisSliceViewer";      }
...
protected:
    ...
    EventProperty<VesselVisSliceViewer>* mouseEventPress_;
    EventProperty<VesselVisSliceViewer>* mouseEventMove_;
    EventProperty<VesselVisSliceViewer>* mouseEventShift_;
...
private:
    VolumePort paramInport_;

	SpatialTransFuncProperty transferFuncVessels_;
	BoolProperty transferFuncVesselsEnableTuned_;
    BoolProperty spatialTFColorCode_;
...
#endif // VRN_VESSELVISSLICEVIEWER_H
