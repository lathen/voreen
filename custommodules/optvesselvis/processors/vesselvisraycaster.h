...
#ifndef VRN_VESSELVISRAYCASTER_H
#define VRN_VESSELVISRAYCASTER_H
 ...
 */
class VRN_CORE_API VesselVisRaycaster : public VolumeRaycaster {
public:
    VesselVisRaycaster();
    virtual Processor* create() const;

    virtual std::string getClassName() const    { return "VesselVisRaycaster"; }
...
private:
    ...
    bool transferFuncVesselsEnableTunedPrevious_;
	...
	EventProperty<VesselVisRaycaster>* mouseEventPress_;
    tgt::ivec2 hitOld_;
    tgt::ivec2 hitPress_;
...
#endif // VRN_VESSELVISRAYCASTER_H
