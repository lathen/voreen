...
#ifndef VRN_SPATIALTRANSFUNC1DKEYSEDITOR_H
#define VRN_SPATIALTRANSFUNC1DKEYSEDITOR_H

#include "spatialtransfunceditor.h"
...
class SpatialTransFuncMappingCanvas;
 ...
 */
class SpatialTransFunc1DKeysEditor : public SpatialTransFuncEditor {
    Q_OBJECT
...
public:
     ...
     */
    SpatialTransFunc1DKeysEditor(SpatialTransFuncProperty* prop, QWidget* parent = 0,
                             Qt::Orientation orientation = Qt::Horizontal);

    /**
     * Standard destructor
     */
    ~SpatialTransFunc1DKeysEditor();

    /**
     * Assigns the passed transfer function property.
     */
    void setTransFuncProp(SpatialTransFuncProperty* prop);

    /**
     * Returns the currently assigned transfer function property.
     */
    const SpatialTransFuncProperty* getTransFuncProp() const;
...
protected:
    ...
    SpatialTransFuncMappingCanvas* transCanvas_;       ///< mapping canvas
...
#endif // VRN_SPATIALTRANSFUNC1DKEYSEDITOR_H
