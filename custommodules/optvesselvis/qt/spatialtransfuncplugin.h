...
#ifndef VRN_SPATIALTRANSFUNCPLUGIN_H
#define VRN_SPATIALTRANSFUNCPLUGIN_H
...
class SpatialTransFuncEditor;
class SpatialTransFuncProperty;
 ...
 */
class SpatialTransFuncPlugin : public QWidget {
    Q_OBJECT
public:
     ...
     */
    SpatialTransFuncPlugin(SpatialTransFuncProperty* prop, QWidget* parent = 0,
                    Qt::Orientation orientation = Qt::Horizontal);

    /**
     * Destructor
     */
    ~SpatialTransFuncPlugin();
...
private:
    std::vector<SpatialTransFuncEditor*> editors_; ///< vector with all editors. The user can choose between all.
    SpatialTransFuncProperty* property_;               ///< transfer function property that belongs to this plugin
...
#endif // VRN_SPATIALTRANSFUNCPLUGIN_H
