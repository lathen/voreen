...
#ifndef VRN_SPATIALTRANSFUNCMAPPINGCANVAS_H
#define VRN_SPATIALTRANSFUNCMAPPINGCANVAS_H
 ...
 * can also be changed.
 */
class VRN_QT_API SpatialTransFuncMappingCanvas : public QWidget, public VolumeObserver {
    Q_OBJECT
public:
     ...
     */
    SpatialTransFuncMappingCanvas(QWidget* parent, TransFunc1DKeys* tf, bool noColor = false,
     ...
     * Destructor
     */
    virtual ~SpatialTransFuncMappingCanvas();
    ...
    void paramChanged(const VolumeBase* paramHandle);
    ...
    void setParamMagnitude(float magnitude) { paramMagnitude_ = magnitude; }

    WindowMode getWindowMode() { return windowMode_; }

    void setWindowMode(WindowMode mode);

    void setKeysLocked(bool locked);

    bool getKeysLocked() { return lockKeysAction_->isChecked(); } 
...
public slots:
    ...
    void changeWindowMode(QAction * action);
...
protected:
    ...
    QAction* lockKeysAction_;
    QAction* windowModeStandardAction_;
    QAction* windowModeCoupledAction_;
    QActionGroup * windowModes_;
...
#endif // VRN_SPATIALTRANSFUNCMAPPINGCANVAS_H
