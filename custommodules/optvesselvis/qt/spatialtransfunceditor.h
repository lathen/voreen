...
#ifndef VRN_SPATIALTRANSFUNCEDITOR_H
#define VRN_SPATIALTRANSFUNCEDITOR_H
 ...
 */
class SpatialTransFuncEditor : public QWidget {
    Q_OBJECT
...
public:
     ...
     */
    SpatialTransFuncEditor(SpatialTransFuncProperty* prop, QWidget* parent = 0);

    /**
     * Destructor
     */
    virtual ~SpatialTransFuncEditor();

    /**
     * Assigns the passed property to the editor. The
     * former property is replaced.
     */
    virtual void setTransFuncProp(SpatialTransFuncProperty* prop);
...
protected:
    SpatialTransFuncProperty* property_; ///< the transfer function property that belongs to this plugin
...
#endif // VRN_SPATIALTRANSFUNCEDITOR_H
