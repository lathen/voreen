...
SpatialTransFuncEditor::SpatialTransFuncEditor(SpatialTransFuncProperty* prop, QWidget* parent)
    : QWidget(parent)
    , property_(prop)
    , volume_(0)
    , paramHandle_(0)
...
SpatialTransFuncEditor::~SpatialTransFuncEditor() {
}

void SpatialTransFuncEditor::toggleInteractionMode(bool on) {
    property_->toggleInteractionMode(on, this);
}

const QString SpatialTransFuncEditor::getOpenFileName(QString filter) {
...
const QString SpatialTransFuncEditor::getSaveFileName(QStringList filters) {
    QFileDialog fileDialog(this);
...
const QString SpatialTransFuncEditor::getTitle() {
    return title_;
}

void SpatialTransFuncEditor::setTransFuncProp(SpatialTransFuncProperty* prop) {
    property_ = prop;
}
